...
AI-generated fiction uses fewer first-person and second-person pronouns relative to total word count. The prose reads as more "reported" than "experienced." Check the pronoun distribution output from `cw check prose`: if a first-person chapter has unusually low I/me/my counts, investigate.

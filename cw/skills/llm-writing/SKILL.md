...
3. **Draft.** For an explicitly writable artifact task, write the draft only to the caller-assigned path and revise it there. Otherwise, draft and revise in the response context without creating or changing files.

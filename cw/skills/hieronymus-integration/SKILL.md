...
description: "Apply the project's free-text memory agreement when literary work uses Hieronymus alongside or instead of file memory. Load when the user requests Hieronymus or the project agreement or binding refers to it; remain optional when its tools are unavailable.\n"
---

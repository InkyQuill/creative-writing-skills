...
Use this generator when a session needs to design political entities: kingdoms, empires, federations, or any political structures that need realistic internal complexity and external relationships. It applies the eight principles that govern how real governance systems form, function, and evolve, producing polities with internal complexity and believable relationships rather than monolithic "evil empires" or "planet of hats" civilizations.
...
Answer the question for every category before selecting a polity type from the matrix.
...
1. **Environmental foundation** — map physical geography and resource distribution, identify natural communication barriers and connections, determine environmental threats and opportunities, and establish the technological context and its implications.
2. **Historical timeline development** — create formation stories for major political entities, identify critical historical junctures and conflicts, map cultural diffusion and divergence patterns, and establish legacy systems and ongoing influence.
3. **Population distribution** — map ethnic/species distribution and density, establish migration patterns and causes, identify demographic tensions and complementarities, and determine urbanization patterns and governance implications.
4. **Economic network mapping** — identify key resource locations and controllers, map trade routes and dependencies, establish wealth distribution patterns, and determine technological specialization areas.
5. **Political structure design** — apply appropriate polity types from the matrix, establish internal cohesion patterns for each entity, map territorial control effectiveness realistically, and identify legitimacy sources for each governance system.
6. **Relationship network creation** — establish alliance patterns and motivations, identify conflict zones and strategic importance, map cultural exchange networks, and determine economic interdependencies.
7. **Layered identity creation** — establish multiple identity levels for populations, create cross-cutting identities that complicate politics, identify identity-based movements and goals, and determine identity markers and significance.
8. **Dynamic element incorporation** — identify entities in different cycle stages, create emergent threats to stability, establish reform movements and opposition, and identify succession questions and controversies.
...
- **With economics:** political and economic systems are deeply intertwined — political systems regulate economics while economic power shapes politics; design together with `resources/generators/economic.md`.
- **With belief systems:** religions supply legitimacy sources and ideological divisions — see `resources/generators/belief.md`.
- **With settlements:** political power expresses itself through urban form — see `resources/generators/settlement.md`.
- **With consequences:** trace political power shifts through society with `resources/generators/systemic.md`.

## Output

Deliver the proposal into the parent world-creation session: the polity type selection from the matrix with naming, parameter choices across the ten categories, internal factions, external relationships (alliances, rivalries, dependencies), the legitimacy sources that justify rule, and distinctive cultural elements and identity markers, plus a founding context and historical development with at least one recent political crisis and the current challenges and succession questions now in motion. Nothing here is canon until the author confirms it; once confirmed, the session persists it through its normal lore-file transaction. Check `$story-memory` conventions for cross-session artifact handling, and use `$creative-research` when modeling on a real political system. Political pressure on individual characters is prose territory — route it to `$creative-writing-craft`, and use `$decision-grill` when the author wants a contested political choice pressure-tested.

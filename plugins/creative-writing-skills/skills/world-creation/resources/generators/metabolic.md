...
Use this generator when a session needs distinct cultures for closed-loop life support systems in space: stations, ships, or habitats where recycled matter creates novel social structures, beliefs, and conflicts. It explores how the physical reality of recycled air, water, and biomass creates cultures that diverge from planetary norms.
...
Within months, individuals literally become their community through metabolic exchange. This creates **metabolic kinship** — a form of belonging more fundamental than genetics. Treat the matter-cycling as literally true and work through its consequences; that concreteness is the entire source of the framework's power.
...
5. **Project historical development.** Consider how the culture reached its current state: founding principles and how they evolved, crisis points that shaped current practices, schisms and reunifications, external influences and rejections.

## Interaction Modeling

When cultures meet, compare positions on each axis:

- **Harmony points** (similar positions): potential for alliance or merger, shared understanding despite other differences, trade opportunities.
- **Friction points** (opposite positions): source of conflicts and misunderstandings, barriers to cooperation, potential for exploitation.
- **Translation needs** (different but not opposite): require cultural interpreters, create specialist roles, generate innovation through synthesis.

## Story Seeds

Combine character types with cultural positions and transition states:
...
Each culture develops an inability to see certain solutions:
...
- **With economics:** metabolic cultures need economic systems adapted to closed loops — labor, trade, resource allocation; see `resources/generators/economic.md`.
- **With belief systems:** religious and philosophical frameworks supply the culture's interpretation of metabolic meaning; see `resources/generators/belief.md`.
- **With governance:** who controls life support is a political question; see `resources/generators/governance.md`.

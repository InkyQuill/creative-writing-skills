...
name: project-setup
description: >
  One-time project setup for creative writing. Interviews you about your project, collects writing samples, proposes kb structure, and creates or updates AGENTS.md with project conventions after you confirm the workspace plan.
---

# Project Setup

Guide the author through setting up their creative writing project. The goal
is a working `AGENTS.md` and directory structure that future sessions and
...
Based on what you learn, draft project instructions for `AGENTS.md` and show them to the
author. Cover:
...
1. Write or update `AGENTS.md` with the agreed content
2. Create the `kb/` directories referenced in `AGENTS.md`
...
If `AGENTS.md` already has creative writing conventions, read it first and
